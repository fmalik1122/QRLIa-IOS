...
class AddProductServicePage extends StatefulWidget {

  String? CateName,CateId;

  AddProductServicePage({this.CateName, this.CateId}) : super();

  @override
  State<AddProductServicePage> createState() => _AddProductServicePageState(CateName, CateId);
}

class _AddProductServicePageState extends State<AddProductServicePage>{
  ...
  _AddProductServicePageState(String? name, String? id) {
    Category  = name;
    CategoryID = id;
  }
